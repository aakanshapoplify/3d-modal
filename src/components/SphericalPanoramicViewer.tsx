...
export default function SphericalPanoramicViewer({ src, isAutoRotating: propAutoRotate, autoRotateSpeed: propAutoRotateSpeed, autoRotateEasing: propAutoRotateEasing, onToggleAutoRotate }: SphericalPanoramicViewerProps) {
  ...
  return (
    <div className="w-full h-full">
      <div className="bg-gradient-to-r from-purple-900/10 via-indigo-900/10 to-purple-900/10 border border-purple-500/20 p-4 rounded-lg mb-4">
      ...
      <div className="relative">
        <div
          ref={containerRef}
          className="w-full aspect-[21/9] rounded-2xl shadow-2xl overflow-hidden cursor-grab active:cursor-grabbing relative bg-black border-2 border-gray-800"
        ...
        {/* Control panel */}
        <div className="absolute bottom-6 right-6 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl rounded-2xl p-4 space-y-2 border border-white/10 shadow-2xl">
          {/* Zoom controls */}
          <div className="flex flex-col space-y-2">
            <button
              onClick={() => setZoom(prev => Math.min(3, prev * 1.2))}
              className="text-white hover:bg-white/10 rounded-xl p-2 transition-all hover:scale-110"
              title="Zoom In"
            >
        ...
        {/* Status overlay */}
        <div className="absolute top-6 left-6 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl text-white px-5 py-4 rounded-2xl text-sm space-y-2 border border-white/10 shadow-2xl">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="font-medium">Yaw: {Math.round(rotationY)}°</span>
          </div>
          <div className="flex items-center space-x-3">
        ...
        <div className="absolute bottom-6 left-6 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl text-white px-5 py-4 rounded-2xl text-xs max-w-sm border border-white/10 shadow-2xl">
          <div className="space-y-2">
            <div className="font-semibold text-purple-300 text-sm mb-3">🌐 Controls:</div>
            <div className="grid grid-cols-2 gap-2">
              <div className="flex items-center space-x-2">
                <span className="text-gray-400">🖱️</span>
                <span className="text-gray-300">Drag to look</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-gray-400">📱</span>
                <span className="text-gray-300">Swipe on mobile</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-gray-400">🎯</span>
                <span className="text-gray-300">Wheel to zoom</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-gray-400">🔄</span>
      ...
      <div className="mt-6 bg-gradient-to-r from-purple-900/10 via-indigo-900/10 to-purple-900/10 p-4 rounded-xl border border-purple-500/20">
        <p className="text-sm text-gray-300">
          🌐 <strong className="text-white">Professional Spherical Viewer:</strong> Experience true spherical projection with smooth 360° navigation, perfect for immersive virtual tours and presentations.
        </p>
      </div>
    </div>
  );
